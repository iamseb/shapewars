...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class GetIPhoneSettings : FsmStateAction
	{
		...
		{
#if UNITY_IPHONE	
			getScreenCanDarken.Value = iPhoneSettings.screenCanDarken;
			getUniqueIdentifier.Value = iPhoneSettings.uniqueIdentifier;
			getName.Value = iPhoneSettings.name;
			getModel.Value = iPhoneSettings.model;
			getSystemName.Value = iPhoneSettings.systemName;
