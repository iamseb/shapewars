...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class SetColorRGBA : FsmStateAction
	{
		...
		void DoSetColorRGBA()
		{
			...
			Color newColor = colorVariable.Value;

			if (!string.IsNullOrEmpty(red.Name))
				newColor.r = red.Value;

			if (!string.IsNullOrEmpty(green.Name))
				newColor.g = green.Value;
			
			if (!string.IsNullOrEmpty(blue.Name))
				newColor.b = blue.Value;
			
			if (!string.IsNullOrEmpty(alpha.Name))
