...
class ExtraPrimitives extends EditorWindow {
	...
	function OnGUI() {
		if (GUILayout.Button ("Create Prefab")) {
			var prefabobj = EditorUtility.CreateEmptyPrefab("Assets/A-Lab Software RapidUnity Extra Primitives/Prefabs/archway_001.prefab");
			archway001 = Instantiate(Resources.Load("archway_001"), Vector3(0, 0, 0), Quaternion.identity);
			EditorUtility.ReplacePrefab(archway001, prefabobj);
